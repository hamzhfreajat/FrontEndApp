            ...
            child: ListView(
              ...
              children: [
                ...
                if (_isLands()) ...[
                  ...
                  _buildMultiSelectSection('المزايا الإضافية والمرافق', ['يوجد مصعد', 'موقف سيارات', 'حارس / أمن وحماية', 'نظام كهرباء احتياطي للطوارئ', 'انتركم', if (!_isCommercial()) ...['حديقة', 'منطقة شواء', 'بركة سباحة']], _selectedExtraFeatures, (val) { setState(() { _selectedExtraFeatures.contains(val) ? _selectedExtraFeatures.remove(val) : _selectedExtraFeatures.add(val); }); _triggerCountUpdate(); }, () { setState(() => _selectedExtraFeatures.clear()); _triggerCountUpdate(); }),
